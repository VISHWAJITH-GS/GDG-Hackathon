...
const MEDALS = [
  {
    ...
    order: 'order-2 sm:order-1', // centre on mobile, left on desktop
    scale: 'scale-100',
  },
  {
    rank: 2,
...
function MedalCard({ citizen, medal, isCurrentUser }) {
  ...
  return (
    ...
    >
      ...
      {/* Medal emoji */}
      <span className="text-4xl mt-2 select-none" role="img" aria-label={medal.label}>
        {medal.emoji}
      </span>
      ...
      {/* Cleared count */}
      <p className={`text-xs font-medium ${medal.sub}`}>
    ...
    <div className="min-h-screen bg-[var(--color-surface,#f0f4fa)]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 space-y-10">
        ...
        <section aria-labelledby="podium-heading">
          <h2
            id="podium-heading"
            className="text-xs font-bold uppercase tracking-widest text-[#104080] mb-6 text-center"
          >
            ⭐ Top Civic Champions
          </h2>
        ...
        <section aria-labelledby="table-heading">
          <div className="flex items-center justify-between mb-4">
            <h2
              id="table-heading"
              className="text-xs font-bold uppercase tracking-widest text-[#104080]"
            >
              📋 Full Rankings
            </h2>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-center">
                            {rankEmoji ? (
                              <span className="text-xl select-none" role="img" aria-label={`Rank ${rank}`}>
                                {rankEmoji}
                              </span>
                            ) : (
